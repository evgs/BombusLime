...
public final class XmppError {
    ...
    public XmppObject construct() {
        if (errCondition==NONE) return null;
        XmppObject error=new XmppObject("error", null, null);
        String type=null;
        switch (errorType) {
    ...
    public static XmppError findInStanza(XmppObject stanza) {
        return decodeStanzaError(stanza.getChildBlock("error"));
    }
    
    public static XmppError decodeStanzaError(XmppObject error) {
    ...
    public static XmppError decodeStreamError(XmppObject error) {
    ...
    public static XmppError decodeSaslError(XmppObject error) {
    ...
    private static XmppError decodeError(XmppObject error, String ns) {
        int errCond=NONE;
        String text=error.getText();
        if (text.length()==0) text=null;
        
        ArrayList<XmppObject> errChilds=error.getChildBlocks();
